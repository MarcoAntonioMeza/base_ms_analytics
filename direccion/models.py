...
#    d_asenta = models.CharField(max_length=100, db_index=True)
#    tipo_asentamiento = models.CharField(max_length=50)
#    municipio = models.ForeignKey(Municipio, on_delete=models.CASCADE, related_name="colonias")
#    codigo_postal = models.ForeignKey(CodigoPostal, on_delete=models.CASCADE, related_name="colonias")
#
#    def __str__(self):
#        return self.d_asenta
#